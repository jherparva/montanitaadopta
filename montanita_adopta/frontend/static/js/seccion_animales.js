...
async function fetchAnimals() {
    ...
    if (currentCategory !== 'all') {
        params.species = currentCategory; // Ya no necesitamos traducir, usamos directamente el valor
    }
    ...
    try {
        ...
        container.innerHTML = `
            <div class="error-message">
                ...
                <p>Error al cargar los animales. Por favor, intenta nuevamente.</p>
